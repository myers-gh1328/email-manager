...
Use this skill for scheduled-email readiness checks and approval-gated processing of scheduled emails ready to send. Scheduled-email draft and schedule MCP tools are deferred; use the web UI or wait for those MCP tools for those workflows.
...
6. Use `prepare_send_due_campaigns` to create the approval packet for scheduled emails ready to send.
